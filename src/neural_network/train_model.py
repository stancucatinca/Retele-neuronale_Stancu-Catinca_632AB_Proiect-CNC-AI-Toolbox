...
# 1. Aflam unde se afla acest fisier (train_model.py)
current_file_path = os.path.abspath(__file__)
# 2. Aflam folderul parinte (neural_network)
current_dir = os.path.dirname(current_file_path)
# 3. Urcam 2 nivele mai sus pentru a ajunge la folderul radacina 'RN'
project_root = os.path.abspath(os.path.join(current_dir, '..', '..'))
# 4. Adaugam aceasta cale in lista unde cauta Python
